import {defaultRequestAddress, HttpUtil, SupportContextType} from "./HttpUtil";
...
const featureAndPath = {
    ...
    QUERY_DRIVER_ORDER_STATUS: {
        method: supportRequestMethod.POST,
        path: "/v1/oms/api/driver/order/queryDriverOrderStatus",
    },
...
export function createChatList(params = {}) {
    return request.post(featureAndPath.CREATE_CHAT_LIST.path, SupportContextType.APPLICATION_JSON, {params: params});
}
