            ...
            <Box bg="white" shadow={2} rounded="lg" p={4} my={2}>
                ...
                <VStack space={1}>
                    ...
                    <HStack space={2} alignItems="flex-start">
                        <RemixIcon name="checkbox-blank-circle-fill" size={15} color="blue" style={{marginTop: 3}}/>
                        <Text style={{flexWrap: 'wrap', flex: 1}}>
                            {item.departureAddress}
                        </Text>
                    </HStack>
                    <HStack space={2} alignItems="flex-start">
                        <RemixIcon name="checkbox-blank-circle-fill" size={15} color="orange" style={{marginTop: 3}}/>
                        <Text style={{flexWrap: 'wrap', flex: 1}}>
                            {item.destinationAddress}
                        </Text>
                    </HStack>
                    <HStack space={2} alignItems="center">
                        <RemixIcon name="money-cny-circle-fill" size={15} color="green" style={{marginTop: 3}}/>
                        <Text>
